...
root_dir=./data/EgoPER/quesadilla
...
do
	echo $video
	CUDA_VISIBLE_DEVICES=2 python -m src.feature_extract --feature_model src/feature_extractor/pretrained_models/kinetics400-rgb-i3d-resnet-50-f32-s2-precise_bn-warmupcosine-bs1024-e196.pth.tar --frames $video_dir/$video --savedir $feature_dir --mp
done
